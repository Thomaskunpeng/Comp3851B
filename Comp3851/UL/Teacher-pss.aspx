    ...
    <div class="container">
        ...
        <div class="box1">
            ...
            <div class="rightbox">
                ...
                <ul class="list">
                    <li>
                        <img src="../DL/images/tou9.png" alt="" class="auto-style1">
                        <div class="info">
                            <h3>Mrs Shirley Kekovski</h3>
                            <p>HR Client Services Advisor</p>
                            <p>Shirley.Kekovski@newcastle.edu.au</p>
                        </div>
                    </li>
                    <li>
                        <img src="../DL/images/tou10.png" alt="" class="auto-style1">
                        <div class="info">
                            <h3>Mr George Rendle</h3>
                            <p>Technical Officer</p>
                            <p>George.Rendle@newcastle.edu.au</p>
                        </div>
                    </li>
                    <li>
                        <img src="../DL/images/tou11.png" alt="" class="auto-style1">
                        <div class="info">
                            <h3>Mr Torrent Rich</h3>
                            <p>Deputy Director Campus Development</p>
                            <p>Torrent.Rich@newcastle.edu.au</p>
                        </div>
                    </li>
                     <li>
                        <img src="../DL/images/tou12.png" alt="" class="auto-style1">
                        <div class="info">
                            <h3>Mr Jeremy Stark</h3>
                            <p>Financial Services</p>
                            <p>Jeremy.Stark@newcastle.edu.au</p>
                        </div>
                    </li>
                </ul>
            </div>
