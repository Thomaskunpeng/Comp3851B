<%@ Page Title="" Language="C#" MasterPageFile="~/Website.Master" AutoEventWireup="true" CodeBehind="Facilities.aspx.cs" Inherits="Comp一号.UL.Facilities" %>
    ...
    <div class="container">
        ...
        <div class="box1">
            ...
            <div class="rightbox">
                ...
                <div class="box">
                    <div class="img1">
                        <img src="../DL/images/f1.png" alt="">
                        
                    </div>
                    <div class="text">
                        Show new students the facilities so that they can easily find and use them .
                    </div>
                </div>
            </div>
        </div>
