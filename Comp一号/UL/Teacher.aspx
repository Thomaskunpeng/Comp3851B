            ...
            <div class="rightbox">
                ...
                <ul class="list">
                   ...
                   <li>
                        <img src="../DL/images/tou.png" alt="">
                        <div class="info">
                            <h3>Mrs Natasha Stone</h3>
                            <p>Lecturer</p>
                            <p>Natasha.Stone@newcastle.edu.au</p>
                        </div>
                    </li>
                    <li>
                        <img src="../DL/images/tou.png" alt="">
                        <div class="info">
                            <h3>Dr Greg Preston</h3>
                            <p>Senior Lecturer</p>
                            <p>Greg.Preston@newcastle.edu.au</p>
                        </div>
                    </li>
                    <li>
                        <img src="../DL/images/tou.png" alt="">
                        <div class="info">
                            <h3>Dr Alexandre Mendes</h3>
                            <p>Senior Lecturer</p>
                            <p>Alexandre.Mendes@newcastle.edu.au</p>
                        </div>
                    </li>
                </ul>
            </div>
