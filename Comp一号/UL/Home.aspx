...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style type="text/css">
        ...
        .homepage {
            ...
            text-align: center;
            height: 1190px;
            background: url('/DL/images/主页页面背景.png') no-repeat center center;
            background-size: cover;
        }
        ...
        .slide {
            ...
            .slide li {
                ...
                .slide li:nth-child(1) {
                    background: url('/DL/images/主页PSB.png') no-repeat;
                    background-size: cover;
                }

                .slide li:nth-child(2) {
                    background: url('/DL/images/草地.png') no-repeat;
                    background-size: cover;
                }

                .slide li:nth-child(3) {
                    background: url('/DL/images/主页火车.png') no-repeat;
                    background-size: cover;
                }
        ...
        <div class="homepage">
            ...
            <ul class="IntStu">
                <li><a href="../UL/InternationalStudent.aspx">
                    <img alt="国际学生" class="auto-style1" src="/DL/images/国际学生.png" /></a></li>
            </ul>
